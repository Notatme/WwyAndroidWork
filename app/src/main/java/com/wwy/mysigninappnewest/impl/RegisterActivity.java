...
public class RegisterActivity extends AppCompatActivity {
    ...
    private  void initView(){      //初始化控件获得值
        ...
        RegBtn.setOnClickListener(new View.OnClickListener() {       //点击注册
            ...
            public void onClick(View v) {
                ...
                addUser(st_number.getText().toString(),username_register.getText().toString(),
    ...
    public void addUser(String Number,String UserName,String Password,String phone,String school,String major){
